  ...
  render() {
    return(
      <div>
        ...
        <p>If your Gotchi has equipped a <a href='https://app.aavegotchi.com/baazaar/wearables?sort=priceLow&filter=all&search=fireball&slot=all'>fireball</a> it can be used as an in game item to deal attack damage and burn damage to enemies.</p>
        <p>If your Gotchi has equipped a <a href='https://app.aavegotchi.com/baazaar/wearables?sort=priceLow&filter=all&search=MK2%20Grenade&slot=all'>MK2 grenade</a> or a <a href='https://app.aavegotchi.com/baazaar/wearables?sort=priceLow&filter=all&search=M67%20Grenade&slot=all'>M67 grenade</a> these can be used as an in game item to deal attack damage and splash damage to nearby enemies.</p>
